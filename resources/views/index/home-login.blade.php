...
@section('content')
  ...
  <div class="jumbotron m-0 bg-gradient" style="height:100vh;">
    <div class="container pt-lg-md">
      <div class="row">
        <div class="col-lg-7" style="display: flex;justify-content: flex-start;align-items: center;">
          <img src="{{url('public/img', $settings->home_index)}}" class="img-center img-fluid d-lg-block d-none" style="max-width: 85%;">
        </div>
        <div class="col-lg-5">
